...
SiguienteCarta():
  Devuelve la siguiente carta que está en la baraja, cuando no haya más o se haya llegado al final,
...
MostrarBaraja():
  Muestra todas las cartas hasta el final. Es decir, si se saca una carta y luego se llama al método,
...
7 - Salir
 */
using Clase14_CartasEspaniolas.Modelo;

//Instancias
// Se utilizan clases de palos para incorporar características gráficas en cada palo
CartasEspaniolas espaniolas = new CartasEspaniolas();
Oro oro = new Oro();
...
var listaMazo = new List<string>(); // Carga el mazo de cartas
string ultimaCarta = "";            // guarda la última carta que fue extraída del mazo
                                    // con este dato se obtiene: carta siguiente, disponibles, monton, listado de cartas, etc 
...
bool continuar = true;  // Controla el bucle principal
do  // Bucle principal
{   // Preparando pantalla    
    Console.Clear();
    Console.WriteLine(tools.PresentationPoster("   Cartas Españolas   "));
    Console.WriteLine(tools.MenuCartas());
    bool seguir = false;    // Controla bucle ingreso opción del menu, para permitir solo ingrso numérico
    int eleccion = 0;
    do   // Bucle opciónl de menu
    {
        Console.Write("Ingrese su opción: -> ");
        
        string ingreso = Console.ReadLine();
        
        bool esNumero = tools.ctrlNumber(ingreso);  // Control ingreso numérico
        if (esNumero)
        {
            Console.Write("                      ");
    ...
    string mensaje = "";    // Personaliza cada una de las pausas luego de cada proceso
                            // es parámetro para PausaContinuar de la clase Tools
        ...
        case 4: // Reparte cartas
            ...
            else
            {
                ...
                {            
                    ...
                    string ingreso = Console.ReadLine();
                    bool esNro = tools.ctrlNumber(ingreso); // Controla que ingreso sea numérico
                    if (esNro)
                    {
                        ...
                        if (largoLista >= cantX)
                        {
                            ...
                            int posX2 = Console.CursorLeft; // Maneja posicion de impresiones
                    ...
                    else
                    {
                        ...
                        //tools.PausaContinuar("Solo se permiten números.");
                        break;
                    }
